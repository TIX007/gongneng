...
只需传入http-request参数即可

```vue
<template>
  <div class="component-upload-image">
    <el-upload :http-request="handleUploadForm" :action="uploadImgUrl" list-type="picture-card"
...
const handleUploadForm = (param) => {
  ...
  formData.append('mainImage', param.file ?? '');
...
const uploadImage = (formData) => {
  ...
  uploadImages(formData).then((res) => {
    ...
    emit("update:modelValue", imageList.mainImage);
    proxy.$modal.closeLoading();
    uploadedSuccessfully();
    console.log('图片提交返回', res, imageList, fileList);
  }).catch((res) => {
